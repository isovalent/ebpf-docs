...
description: "This page documents the 'bpf_sk_lookup_tcp' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---
...
`#!c static struct bpf_sock *(* const bpf_sk_lookup_tcp)(void *ctx, struct bpf_sock_tuple *tuple, __u32 tuple_size, __u64 netns, __u64 flags) = (void *) 84;`
<!-- [/HELPER_FUNC_DEF] -->

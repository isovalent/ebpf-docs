---
title: "Helper Function 'bpf_ktime_get_ns'"
description: "This page documents the 'bpf_ktime_get_ns' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---

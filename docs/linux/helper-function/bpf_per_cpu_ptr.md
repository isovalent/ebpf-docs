---
title: "Helper Function 'bpf_per_cpu_ptr'"
description: "This page documents the 'bpf_per_cpu_ptr' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---
...
bpf_per_cpu_ptr() has the same semantic as per_cpu_ptr() in the kernel, except that bpf_per_cpu_ptr() may return NULL. This happens if _cpu_ is larger than nr_cpu_ids. The caller of bpf_per_cpu_ptr() must check the returned value.

...
description: "This page documents the 'bpf_probe_read' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---
...
`#!c static long (* const bpf_probe_read)(void *dst, __u32 size, const void *unsafe_ptr) = (void *) 4;`
<!-- [/HELPER_FUNC_DEF] -->

...
description: "This page documents the 'bpf_skb_cgroup_classid' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---

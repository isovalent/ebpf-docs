...
description: "This page documents the 'bpf_sock_hash_update' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---

...
description: "This page documents the 'bpf_current_task_under_cgroup' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---

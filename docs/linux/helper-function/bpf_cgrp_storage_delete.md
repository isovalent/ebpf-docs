---
title: "Helper Function 'bpf_cgrp_storage_delete'"
description: "This page documents the 'bpf_cgrp_storage_delete' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---

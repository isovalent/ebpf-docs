...
description: "This page documents the 'bpf_skb_ancestor_cgroup_id' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---

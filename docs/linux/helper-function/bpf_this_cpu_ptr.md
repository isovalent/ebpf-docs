...
description: "This page documents the 'bpf_this_cpu_ptr' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---
...
<!-- [HELPER_FUNC_DEF] -->
Take a pointer to a percpu ksym, _percpu_ptr_, and return a pointer to the percpu kernel variable on this cpu. See the description of 'ksym' in **bpf_per_cpu_ptr**().

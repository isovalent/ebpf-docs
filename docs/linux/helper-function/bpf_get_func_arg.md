---
title: "Helper Function 'bpf_get_func_arg'"
description: "This page documents the 'bpf_get_func_arg' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---

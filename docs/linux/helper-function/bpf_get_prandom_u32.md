---
title: "Helper Function 'bpf_get_prandom_u32'"
description: "This page documents the 'bpf_get_prandom_u32' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---

---
title: "Helper Function 'bpf_get_smp_processor_id'"
description: "This page documents the 'bpf_get_smp_processor_id' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---

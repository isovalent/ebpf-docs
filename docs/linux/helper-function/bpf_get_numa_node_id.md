...
description: "This page documents the 'bpf_get_numa_node_id' eBPF helper function, including its definition, usage, program types that can use it, and examples."
---

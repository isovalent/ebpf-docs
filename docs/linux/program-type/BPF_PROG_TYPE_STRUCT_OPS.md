...
??? abstract "Supported kfuncs"
    ...
    - [`__scx_bpf_dsq_insert_vtime`](../kfuncs/__scx_bpf_dsq_insert_vtime.md)
    - [`__scx_bpf_select_cpu_and`](../kfuncs/__scx_bpf_select_cpu_and.md)
    - [`bbr_cwnd_event_tx_start`](../kfuncs/bbr_cwnd_event_tx_start.md)
    ...
    - [`bpf_list_push_front`](../kfuncs/bpf_list_push_front.md)
    ...
    - [`bpf_stream_print_stack`](../kfuncs/bpf_stream_print_stack.md)
    - [`bpf_stream_vprintk`](../kfuncs/bpf_stream_vprintk.md)
    - [`bpf_strlen`](../kfuncs/bpf_strlen.md)
    - [`bpf_strncasecmp`](../kfuncs/bpf_strncasecmp.md)
    ...
    - [`bpf_task_work_schedule_resume`](../kfuncs/bpf_task_work_schedule_resume.md)
    - [`bpf_task_work_schedule_signal`](../kfuncs/bpf_task_work_schedule_signal.md)
    - [`bpf_throw`](../kfuncs/bpf_throw.md)
    - [`bpf_timer_cancel_async`](../kfuncs/bpf_timer_cancel_async.md)
    - [`bpf_wq_init`](../kfuncs/bpf_wq_init.md)
    - [`bpf_wq_set_callback`](../kfuncs/bpf_wq_set_callback.md)
    ...
    - [`cubictcp_cwnd_event_tx_start`](../kfuncs/cubictcp_cwnd_event_tx_start.md)
    ...
    - [`dctcp_cwnd_event_tx_start`](../kfuncs/dctcp_cwnd_event_tx_start.md)
    ...
    - [`scx_bpf_cpu_curr`](../kfuncs/scx_bpf_cpu_curr.md)
    ...
    - [`scx_bpf_dispatch_cancel`](../kfuncs/scx_bpf_dispatch_cancel.md)
    - [`scx_bpf_dispatch_nr_slots`](../kfuncs/scx_bpf_dispatch_nr_slots.md)
    - [`scx_bpf_dsq_insert`](../kfuncs/scx_bpf_dsq_insert.md)
    - [`scx_bpf_dsq_insert___v2`](../kfuncs/scx_bpf_dsq_insert___v2.md)
    - [`scx_bpf_dsq_insert_vtime`](../kfuncs/scx_bpf_dsq_insert_vtime.md)
    ...
    - [`scx_bpf_dsq_move_to_local`](../kfuncs/scx_bpf_dsq_move_to_local.md)
    - [`scx_bpf_dsq_move_to_local___v2`](../kfuncs/scx_bpf_dsq_move_to_local___v2.md)
    ...
    - [`scx_bpf_locked_rq`](../kfuncs/scx_bpf_locked_rq.md)
    ...
    - [`scx_bpf_reenqueue_local`](../kfuncs/scx_bpf_reenqueue_local.md)
    - [`scx_bpf_reenqueue_local___v2`](../kfuncs/scx_bpf_reenqueue_local___v2.md)
    - [`scx_bpf_select_cpu_and`](../kfuncs/scx_bpf_select_cpu_and.md)
    - [`scx_bpf_select_cpu_dfl`](../kfuncs/scx_bpf_select_cpu_dfl.md)
    - [`scx_bpf_sub_dispatch`](../kfuncs/scx_bpf_sub_dispatch.md)
    ...
    - [`scx_bpf_task_set_dsq_vtime`](../kfuncs/scx_bpf_task_set_dsq_vtime.md)
    - [`scx_bpf_task_set_slice`](../kfuncs/scx_bpf_task_set_slice.md)

---
title: "Program Type 'BPF_PROG_TYPE_LWT_IN'"
description: "This page documents the 'BPF_PROG_TYPE_LWT_IN' eBPF program type, including its definition, usage, program types that can use it, and examples."
---
# Program type `BPF_PROG_TYPE_LWT_IN`

<!-- [FEATURE_TAG](BPF_PROG_TYPE_LWT_IN) -->
...
This program type can be attached to route, the program will be called for incoming packets from said route. For example
...
After [:octicons-tag-24: v5.1](https://github.com/torvalds/linux/commit/3e0bd37ce0e4a574df6d87a901e13bcb46e10301) the LWT input program can encapsulate the packet with the [`bpf_lwt_push_encap`](../helper-function/bpf_lwt_push_encap.md) helper function and the `BPF_LWT_ENCAP_IP` mode.

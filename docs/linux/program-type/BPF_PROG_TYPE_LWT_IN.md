...
After [:octicons-tag-24: v5.1](https://github.com/torvalds/linux/commit/3e0bd37ce0e4a574df6d87a901e13bcb46e10301) the LWT input program can encpasulate the packet with the [`bpf_lwt_push_encap`](../helper-function/bpf_lwt_push_encap.md) helper function and the `BPF_LWT_ENCAP_IP` mode.

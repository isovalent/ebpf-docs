---
title: "KFunc 'bpf_strncasestr'"
description: "This page documents the 'bpf_strncasestr' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_strncasestr`

<!-- [FEATURE_TAG](bpf_strncasestr) -->
[:octicons-tag-24: v6.19](https://github.com/torvalds/linux/commit/b5b693f73589283e75436e64fab46bf6298abd89)
<!-- [/FEATURE_TAG] -->

Find the first sub-string in a length-limited string, ignoring the case of the characters.
 ...
 * `>=0`     - Index of the first character of the first occurrence of `s2__ign` within `s1__ign`
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_strncasestr(const char *s1__ign, const char *s2__ign, size_t len)`
<!-- [/KFUNC_DEF] -->

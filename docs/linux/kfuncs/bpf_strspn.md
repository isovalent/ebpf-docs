---
title: "KFunc 'bpf_strspn'"
description: "This page documents the 'bpf_strspn' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_strspn`

<!-- [FEATURE_TAG](bpf_strspn) -->
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_strspn(const char *s__ign, const char *accept__ign)`
<!-- [/KFUNC_DEF] -->

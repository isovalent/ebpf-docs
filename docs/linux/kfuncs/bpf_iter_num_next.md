---
title: "KFunc 'bpf_iter_num_next'"
description: "This page documents the 'bpf_iter_num_next' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---

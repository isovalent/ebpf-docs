---
title: "KFunc 'bpf_res_spin_unlock'"
description: "This page documents the 'bpf_res_spin_unlock' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_res_spin_unlock`

<!-- [FEATURE_TAG](bpf_res_spin_unlock) -->
...
<!-- [KFUNC_DEF] -->
`#!c void bpf_res_spin_unlock(struct bpf_res_spin_lock *lock)`
<!-- [/KFUNC_DEF] -->

---
title: "KFunc 'bpf_wq_set_callback'"
description: "This page documents the 'bpf_wq_set_callback' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_wq_set_callback`

<!-- [FEATURE_TAG](bpf_wq_set_callback) -->
[:octicons-tag-24: v7.0](https://github.com/torvalds/linux/commit/b97931a25a4bc74076ffb5c3d1a534c71ade4d55)
<!-- [/FEATURE_TAG] -->

Set callback function for a BPF workqueue.

!!! note
    This kfunc supersedes `bpf_wq_set_callback_impl`, migrated to use implicit arguments in [:octicons-tag-24: v7.0](https://github.com/torvalds/linux/commit/b97931a25a4bc74076ffb5c3d1a534c71ade4d55).
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_wq_set_callback(struct bpf_wq *wq, int (callback_fn)(void * , int * , void * ), unsigned int flags)`
<!-- [/KFUNC_DEF] -->

## Usage

This kfunc sets the callback for workqueue object so that [`bpf_wq_start`](bpf_wq_start.md) can execute it later.

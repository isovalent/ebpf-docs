---
title: "KFunc '__bpf_trap'"
description: "This page documents the '__bpf_trap' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `__bpf_trap`

<!-- [FEATURE_TAG](__bpf_trap) -->
[:octicons-tag-24: v6.16](https://github.com/torvalds/linux/commit/f95695f2c46592b4260032736a9bfc6e2a01c77c)
<!-- [/FEATURE_TAG] -->

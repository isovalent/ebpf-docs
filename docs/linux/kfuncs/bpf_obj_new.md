---
title: "KFunc 'bpf_obj_new'"
description: "This page documents the 'bpf_obj_new' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_obj_new`
...
A pointer to an object of the type corresponding to the passed in `local_type_id__k`, or NULL on failure.

**Signature**

<!-- [KFUNC_DEF] -->
`#!c void *bpf_obj_new(u64 local_type_id__k)`

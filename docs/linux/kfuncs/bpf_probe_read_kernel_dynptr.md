---
title: "KFunc 'bpf_probe_read_kernel_dynptr'"
description: "This page documents the 'bpf_probe_read_kernel_dynptr' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_probe_read_kernel_dynptr`

<!-- [FEATURE_TAG](bpf_probe_read_kernel_dynptr) -->
[:octicons-tag-24: v6.16](https://github.com/torvalds/linux/commit/a498ee7576de24b4b0916ce56cf2686e261a29f7)
<!-- [/FEATURE_TAG] -->

Probes kernel-space data into a [dynptr](../concepts/dynptrs.md)
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_probe_read_kernel_dynptr(struct bpf_dynptr *dptr, u32 off, u32 size, const void *unsafe_ptr__ign)`
<!-- [/KFUNC_DEF] -->

## Usage

This kfunc can be used to probe a dynamic (not known at verification time) amount of bytes from kernel memory into a [dynamic pointer](../concepts/dynptrs.md) buffer.

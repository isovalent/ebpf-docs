...
!!! note
    In [:octicons-tag-24: v6.17](https://github.com/torvalds/linux/commit/5ab154f1463a111e1dc8fd5d31eaa7a2a71fe2e6) this kfunc was introduced under `bpf_stream_vprintk` and renamed to `bpf_stream_vprintk_impl` in [:octicons-tag-24: v6.18](https://github.com/torvalds/linux/commit/137cc92ffe2e71705fce112656a460d924934ebe).
    In [:octicons-tag-24: v7.0](https://github.com/torvalds/linux/commit/d806f3101276a1ed18d963944580e1ee1c7a3d26) it was renamed back to `bpf_stream_vprintk` but with `KF_IMPLICIT_ARGS` which makes the `aux__prog` argument implicitly added.
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_stream_vprintk(int stream_id, const char *fmt__str, const void *args, u32 len__sz)`
<!-- [/KFUNC_DEF] -->

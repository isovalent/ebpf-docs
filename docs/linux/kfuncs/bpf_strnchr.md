---
title: "KFunc 'bpf_strnchr'"
description: "This page documents the 'bpf_strnchr' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_strnchr`

<!-- [FEATURE_TAG](bpf_strnchr) -->
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_strnchr(const char *s__ign, size_t count, char c)`
<!-- [/KFUNC_DEF] -->

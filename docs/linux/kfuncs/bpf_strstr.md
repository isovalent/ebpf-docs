---
title: "KFunc 'bpf_strstr'"
description: "This page documents the 'bpf_strstr' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_strstr`

<!-- [FEATURE_TAG](bpf_strstr) -->
 ...
 * `>=0`     - Index of the first character of the first occurrence of `s2__ig` within `s1__ign`
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_strstr(const char *s1__ign, const char *s2__ign)`
<!-- [/KFUNC_DEF] -->

---
title: "KFunc 'bpf_strcasestr'"
description: "This page documents the 'bpf_strcasestr' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_strcasestr`

<!-- [FEATURE_TAG](bpf_strcasestr) -->
[:octicons-tag-24: v6.19](https://github.com/torvalds/linux/commit/b5b693f73589283e75436e64fab46bf6298abd89)
<!-- [/FEATURE_TAG] -->

Find the first sub-string in a string, ignoring the case of the characters
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_strcasestr(const char *s1__ign, const char *s2__ign)`
<!-- [/KFUNC_DEF] -->

---
title: "KFunc 'bpf_dynptr_file_discard'"
description: "This page documents the 'bpf_dynptr_file_discard' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_dynptr_file_discard`

<!-- [FEATURE_TAG](bpf_dynptr_file_discard) -->
[:octicons-tag-24: v6.19](https://github.com/torvalds/linux/commit/8d8771dc03e48300e80b43744dd3c320ccaf746a)
<!-- [/FEATURE_TAG] -->

Discard a [dynptr](../concepts/dynptrs.md) created with [`bpf_dynptr_from_file`](bpf_dynptr_from_file.md).

## Definition

**Parameters**

`dynptr`: The [dynptr](../concepts/dynptrs.md) to be cleaned up.

**Signature**

<!-- [KFUNC_DEF] -->
`#!c int bpf_dynptr_file_discard(struct bpf_dynptr *dynptr)`
<!-- [/KFUNC_DEF] -->

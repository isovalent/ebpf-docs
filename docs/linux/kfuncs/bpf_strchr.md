---
title: "KFunc 'bpf_strchr'"
description: "This page documents the 'bpf_strchr' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_strchr`

<!-- [FEATURE_TAG](bpf_strchr) -->
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_strchr(const char *s__ign, char c)`
<!-- [/KFUNC_DEF] -->

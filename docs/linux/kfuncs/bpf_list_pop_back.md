---
title: "KFunc 'bpf_list_pop_back'"
description: "This page documents the 'bpf_list_pop_back' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---

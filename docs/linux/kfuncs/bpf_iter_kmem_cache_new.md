---
title: "KFunc 'bpf_iter_kmem_cache_new'"
description: "This page documents the 'bpf_iter_kmem_cache_new' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_iter_kmem_cache_new`

<!-- [FEATURE_TAG](bpf_iter_kmem_cache_new) -->
[:octicons-tag-24: v6.13](https://github.com/torvalds/linux/commit/2e9a548009c2d804e55cdd5b0e9903756cf7d9b3)
<!-- [/FEATURE_TAG] -->

This function initializes a iterator for slab caches.
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_iter_kmem_cache_new(struct bpf_iter_kmem_cache *it)`

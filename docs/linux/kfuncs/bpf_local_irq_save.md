---
title: "KFunc 'bpf_local_irq_save'"
description: "This page documents the 'bpf_local_irq_save' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_local_irq_save`

<!-- [FEATURE_TAG](bpf_local_irq_save) -->
[:octicons-tag-24: v6.14](https://github.com/torvalds/linux/commit/c8e2ee1f3df05dc4caa746c062c6b5791c745c79)
<!-- [/FEATURE_TAG] -->
...
<!-- [KFUNC_DEF] -->
`#!c void bpf_local_irq_save(long unsigned int *flags__irq_flag)`
<!-- [/KFUNC_DEF] -->

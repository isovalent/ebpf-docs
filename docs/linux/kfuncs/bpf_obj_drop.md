---
title: "KFunc 'bpf_obj_drop'"
description: "This page documents the 'bpf_obj_drop' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_obj_drop`

<!-- [FEATURE_TAG](bpf_obj_drop) -->
...
<!-- [KFUNC_DEF] -->
`#!c void bpf_obj_drop(void *p__alloc)`

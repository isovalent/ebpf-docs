---
title: "KFunc 'bpf_dynptr_from_skb_meta'"
description: "This page documents the 'bpf_dynptr_from_skb_meta' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_dynptr_from_skb_meta`

<!-- [FEATURE_TAG](bpf_dynptr_from_skb_meta) -->
[:octicons-tag-24: v6.18](https://github.com/torvalds/linux/commit/89d912e494f786e79f69ed9d567a8842c71dbb03)
<!-- [/FEATURE_TAG] -->

Initialize a dynptr to the skb metadata area.

## Definition

Set up a dynptr for access to the metadata area earlier allocated from the XDP context with [`bpf_xdp_adjust_meta`](../helper-function/bpf_xdp_adjust_meta.md). Serves as an alternative to [`&__sk_buff->data_meta`](../program-context/__sk_buff.md#data_meta).

If passed `skb_` is a clone which shares the data with the original, the dynptr will be read-only. This limitation may be lifted in the future.
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_dynptr_from_skb_meta(struct __sk_buff *skb_, u64 flags, struct bpf_dynptr *ptr__uninit)`
<!-- [/KFUNC_DEF] -->

## Usage

It abstracts away the fact where the storage for the custom metadata lives, which opens up the way to persist the metadata by relocating it as the skb travels through the network stack layers.
...
Example from [`tools/testing/selftests/bpf/progs/test_xdp_meta.c`](https://github.com/torvalds/linux/blob/b927546677c876e26eba308550207c2ddf812a43/tools/testing/selftests/bpf/progs/test_xdp_meta.c)

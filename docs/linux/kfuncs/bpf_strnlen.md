---
title: "KFunc 'bpf_strnlen'"
description: "This page documents the 'bpf_strnlen' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_strnlen`
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_strnlen(const char *s__ign, size_t count)`
<!-- [/KFUNC_DEF] -->

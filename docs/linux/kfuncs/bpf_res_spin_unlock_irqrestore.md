---
title: "KFunc 'bpf_res_spin_unlock_irqrestore'"
description: "This page documents the 'bpf_res_spin_unlock_irqrestore' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_res_spin_unlock_irqrestore`

<!-- [FEATURE_TAG](bpf_res_spin_unlock_irqrestore) -->
...
<!-- [KFUNC_DEF] -->
`#!c void bpf_res_spin_unlock_irqrestore(struct bpf_res_spin_lock *lock, long unsigned int *flags__irq_flag)`
<!-- [/KFUNC_DEF] -->

---
title: "KFunc 'bpf_dynptr_slice'"
description: "This page documents the 'bpf_dynptr_slice' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
...
If the dynptr has some data in page buffer for `BPF_PROG_TYPE_SK_SKB`, return `buffer__opt` not `NULL` .  

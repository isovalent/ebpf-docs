---
title: "KFunc 'bpf_xdp_ct_lookup'"
description: "This page documents the 'bpf_xdp_ct_lookup' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---

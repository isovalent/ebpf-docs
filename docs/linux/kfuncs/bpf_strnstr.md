---
title: "KFunc 'bpf_strnstr'"
description: "This page documents the 'bpf_strnstr' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_strnstr`

<!-- [FEATURE_TAG](bpf_strnstr) -->
[:octicons-tag-24: v6.17](https://github.com/torvalds/linux/commit/e91370550f1fe6fa3b02e8bf9762e3dc0a02fcad)
<!-- [/FEATURE_TAG] -->

Find the first sub-string in a length-limited string
 ...
 * `>=0`     - Index of the first character of the first occurrence of `s2__ign` within the first `len` characters of `s1__ign`
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_strnstr(const char *s1__ign, const char *s2__ign, size_t len)`
<!-- [/KFUNC_DEF] -->

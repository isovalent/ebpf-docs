---
title: "KFunc 'bpf_probe_read_kernel_str_dynptr'"
description: "This page documents the 'bpf_probe_read_kernel_str_dynptr' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_probe_read_kernel_str_dynptr`

<!-- [FEATURE_TAG](bpf_probe_read_kernel_str_dynptr) -->
[:octicons-tag-24: v6.16](https://github.com/torvalds/linux/commit/a498ee7576de24b4b0916ce56cf2686e261a29f7)
<!-- [/FEATURE_TAG] -->

probes kernel-space string into a [dynptr](../concepts/dynptrs.md)

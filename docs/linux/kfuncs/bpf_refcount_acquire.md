---
title: "KFunc 'bpf_refcount_acquire'"
description: "This page documents the 'bpf_refcount_acquire' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
...
<!-- [KFUNC_DEF] -->
`#!c void *bpf_refcount_acquire(void *p__refcounted_kptr)`

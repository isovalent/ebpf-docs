---
title: "KFunc 'bpf_iter_bits_next'"
description: "This page documents the 'bpf_iter_bits_next' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_iter_bits_next`

<!-- [FEATURE_TAG](bpf_iter_bits_next) -->
...
<!-- [KFUNC_DEF] -->
`#!c int *bpf_iter_bits_next(struct bpf_iter_bits *it)`

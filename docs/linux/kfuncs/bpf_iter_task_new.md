---
title: "KFunc 'bpf_iter_task_new'"
description: "This page documents the 'bpf_iter_task_new' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---

---
title: "KFunc 'bpf_strrchr'"
description: "This page documents the 'bpf_strrchr' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_strrchr`

<!-- [FEATURE_TAG](bpf_strrchr) -->
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_strrchr(const char *s__ign, int c)`
<!-- [/KFUNC_DEF] -->

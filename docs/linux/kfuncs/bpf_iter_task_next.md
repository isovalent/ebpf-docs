---
title: "KFunc 'bpf_iter_task_next'"
description: "This page documents the 'bpf_iter_task_next' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---

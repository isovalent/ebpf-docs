---
title: "KFunc 'bpf_cgroup_read_xattr'"
description: "This page documents the 'bpf_cgroup_read_xattr' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_cgroup_read_xattr`

<!-- [FEATURE_TAG](bpf_cgroup_read_xattr) -->
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_cgroup_read_xattr(struct cgroup *cgroup, const char *name__str, struct bpf_dynptr *value_p)`
<!-- [/KFUNC_DEF] -->

---
title: "KFunc 'bpf_percpu_obj_drop'"
description: "This page documents the 'bpf_percpu_obj_drop' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
...
<!-- [KFUNC_DEF] -->
`#!c void bpf_percpu_obj_drop(void *p__alloc)`

---
title: "KFunc 'bpf_strcspn'"
description: "This page documents the 'bpf_strcspn' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_strcspn`

<!-- [FEATURE_TAG](bpf_strcspn) -->
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_strcspn(const char *s__ign, const char *reject__ign)`
<!-- [/KFUNC_DEF] -->

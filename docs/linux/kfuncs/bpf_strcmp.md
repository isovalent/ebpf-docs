---
title: "KFunc 'bpf_strcmp'"
description: "This page documents the 'bpf_strcmp' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_strcmp`

<!-- [FEATURE_TAG](bpf_strcmp) -->
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_strcmp(const char *s1__ign, const char *s2__ign)`
<!-- [/KFUNC_DEF] -->

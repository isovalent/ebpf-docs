---
title: "KFunc 'bpf_strchrnul'"
description: "This page documents the 'bpf_strchrnul' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_strchrnul`

<!-- [FEATURE_TAG](bpf_strchrnul) -->
 ...
 * `>=0`      - Index of the first occurrence of `c` within `s__ign` or index of the null byte at the end of `s__ign` when `c` is not found
...
<!-- [KFUNC_DEF] -->
`#!c int bpf_strchrnul(const char *s__ign, char c)`
<!-- [/KFUNC_DEF] -->

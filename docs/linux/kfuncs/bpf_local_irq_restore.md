---
title: "KFunc 'bpf_local_irq_restore'"
description: "This page documents the 'bpf_local_irq_restore' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_local_irq_restore`

<!-- [FEATURE_TAG](bpf_local_irq_restore) -->
...
<!-- [KFUNC_DEF] -->
`#!c void bpf_local_irq_restore(long unsigned int *flags__irq_flag)`
<!-- [/KFUNC_DEF] -->

---
title: "KFunc 'bpf_dynptr_copy'"
description: "This page documents the 'bpf_dynptr_copy' eBPF kfunc, including its definition, usage, program types that can use it, and examples."
---
# KFunc `bpf_dynptr_copy`

<!-- [FEATURE_TAG](bpf_dynptr_copy) -->
[:octicons-tag-24: v6.15](https://github.com/torvalds/linux/commit/daec295a70941c556708c59e1f970a24d8194d89)
<!-- [/FEATURE_TAG] -->
...
!!! note
    In [:octicons-tag-24: v6.19](https://github.com/torvalds/linux/commit/531b87d865eb9e625c2e46ec8f06a65a6157ee45) the signature of this kfunc changed from `u32` to `u64` types for `dst_off` and `src_off`. This may require CO-RE logic to select the correct kfunc.
